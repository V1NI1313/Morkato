...
class Commands(commands.Cog):
  ...
  async def Console(self, ctx: commands.Context, *, code: str) -> None:
    ...
    if match is None:
      ...
      module = {"__builtins__": {"__import__": __load__, "open": open, "True": True, "False": False, "str": str, "int": int, "bool": bool, "dict": dict, "tuple": tuple, "list": list,"enumerate": enumerate, "zip": zip, "getattr": getattr, "setattr": setattr, "__build_class__": __build_class__, "__name__": __name__, "property": property, "super": super, "type": type, "map": map, "next": next, 'echo': print}}
